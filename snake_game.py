...
def randomize_food_size():
    global FOOD_SIZE
    global FOOD_SIZES
    FOOD_SIZE = np.random.choice(FOOD_SIZES)
    # print(FOOD_SIZE)
...
def randomize_food_colours():
    global final_food_size
    final_food_colour = np.random.choice(FOOD_COLOURS)

randomize_food_colours()

DELAY = 100
PAUSE_GAME = FALSE

# pause delay
PAUSE_DELAY = 300 # 31556926000  # Milliseconds between screen updates
...
def bind_direction_keys():
    ...
    screen.onkey(lambda: pause_game(), "q")
